...
public class AutoCommand1 extends Command {
  ...
  public AutoCommand1(SwerveDriveSimulation driveSimulation, VisionSubsystem visionSubsystem, IntakeSubsystem intakeSubsystem, ShooterSubsystem shooterSubsystem) {
  ...
  driveController.requestVoltage(Volts.of(0));
  
  steerController.requestVoltage(Volts.of(1));
    }
timer = new Timer();
timer.start();
  }
  ...
  steerController.requestVoltage(Volts.of(-0.8));
    }
      if(followPath != null){
      followPath.cancel();
      }
  ...
  public void end(boolean interrupted) {
    ...
    new AutoCommand2(driveTrainSubsystem, visionSubsystem, intakeSubsystem, shooterSubsystem).schedule();
    }
